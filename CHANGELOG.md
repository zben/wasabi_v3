...
* Fix: [#32](https://github.com/savonrb/wasabi_v3/issues/32) fixes a regression in operation names that was adversely affecting Savon: https://github.com/savonrb/savon/issues/520
...
* Feature: [#20](https://github.com/savonrb/wasabi_v3/issues/20) Limited support for listing an
  operation's parameters. Please note that if your WSDL defines imports, this method might
  not return all types.

* Improvement: [#7](https://github.com/savonrb/wasabi_v3/issues/7) Major speed improvements.

* Improvement: [#16](https://github.com/savonrb/wasabi_v3/issues/16) Various improvements regarding
  element order and type information.

* Fix: [#25](https://github.com/savonrb/wasabi_v3/issues/25) Fixes a problem where WasabiV3 escaped
  an already escaped endpoint URL.

* Fix: [#15](https://github.com/savonrb/wasabi_v3/issues/15) Fixes a bug where the operation tag
  name was not correctly extracted from the WSDL document.

## 3.1.0 (2013-04-21)

* Feature: [#22](https://github.com/savonrb/wasabi_v3/issues/22) added `WasabiV3::Document#service_name`
  to return the name of the SOAP service. Original issue: [savonrb/savon#408](https://github.com/savonrb/savon/pull/408).

* Fix: [#21](https://github.com/savonrb/wasabi_v3/issues/21) when the Resolver gets an
  erroneous response (such as a 404), we now raise a more useful HTTPError.

* Fix: [#23](https://github.com/savonrb/wasabi_v3/issues/23) ignore extension base elements
  defined in imports.
...
* Fix: [#14](https://github.com/savonrb/wasabi_v3/issues/14) fixes an issue where
  ...
  The bug was introduced in v2.2.0 by [583cf6](https://github.com/savonrb/wasabi_v3/commit/583cf658f1953411a7a7a4c22923fa0a046c8d6d)

* Refactoring: Removed `Object#blank?` core extension.

## 2.5.0 (2012-06-28)

* Fix: [#10](https://github.com/savonrb/wasabi_v3/issues/10) fixes an issue where
  WasabiV3 used the wrong operation name.
...
* Feature: `WasabiV3::Document` now accepts either a URL of a remote document,
...
* Improvement: [#3](https://github.com/savonrb/wasabi_v3/pull/3) adds object inheritance.

## 2.2.0 (2012-06-06)

* Improvement: [#5](https://github.com/savonrb/wasabi_v3/pull/5) - Get input from message
...
* Fix: [issue 7](https://github.com/savonrb/wasabi_v3/issues/7) - Performance regression.

## 2.1.0 (2012-02-17)

* Improvement: The value of elementFormDefault can now be manually specified/overwritten.

* Improvement: [issue 2](https://github.com/savonrb/wasabi_v3/issues/2) - Allow symbolic endpoints
  like "http://server:port".

## 2.0.0 (2011-07-07)

* Feature: WasabiV3 can now parse type definitions and namespaces.
