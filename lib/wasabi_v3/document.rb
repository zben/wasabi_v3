...
module WasabiV3
  ...
  class Document
    ...
    # Parses the WSDL document and returns the <tt>WasabiV3::Parser</tt>.
    def parser
  ...
  private
    ...
    def guard_parse
      ...
      raise ArgumentError, "WasabiV3 needs a WSDL document"
    end

    # Parses the WSDL document and returns <tt>WasabiV3::Parser</tt>.
    def parse
